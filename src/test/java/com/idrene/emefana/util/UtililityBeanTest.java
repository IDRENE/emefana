...
public class UtililityBeanTest extends AbstractIntegrationTest{
	...
	public void testSecretKeyEncryptDecrypt() throws Exception{
		SecretKey secretKey = UtilityBean.secretKey();
		String encryptedText = UtilityBean.encrypt("OmG", secretKey);
		assertTrue("OmG".equals(UtilityBean.decrypt(encryptedText, secretKey)));
	}
	...
	public void testSecretKeyTextEncryptDecrypt() throws Exception{
		String secretKey = UtilityBean.secretKeyText();
		String encryptedText = UtilityBean.encrypt("OmG", secretKey);
		assertTrue("OmG".equals(UtilityBean.decrypt(encryptedText, secretKey)));
	...
	public void testSecretKeyTextEncryptDecryptBean() throws Exception{
		String encryptedText = UtilityBean.encrypt("Emefana2014", utilityBean.getSECRET_KEY());
		assertTrue("Emefana2014".equals(UtilityBean.decrypt(encryptedText, utilityBean.getSECRET_KEY())));
